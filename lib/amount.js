...
const bsert_1 = require("bsert");
const fixed_1 = require("./bcoin/utils/fixed");
const utils_1 = require("./bcoin/utils");
class Amount {
    ...
    fromValue(value) {
        (0, bsert_1.default)(Number.isSafeInteger(value) && value >= 0, "Value must be an int64.");
        this.value = value;
        return this;
    }
    fromSatoshis(value) {
    ...
    static encode(value, exp, num) {
        if (num)
            return fixed_1.default.toFloat(value, exp);
        return fixed_1.default.encode(value, exp);
    }
    static decode(value, exp) {
        if (typeof value === "number")
            return fixed_1.default.fromFloat(value, exp);
        return fixed_1.default.decode(value, exp);
    }
}
