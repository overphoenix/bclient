...
consensus.BASE_REWARD = 50 * consensus.COIN;
...
consensus.HALF_REWARD = Math.floor(consensus.BASE_REWARD / 2);
...
consensus.MAX_BLOCK_SIZE = 1000000;
...
consensus.MAX_RAW_BLOCK_SIZE = 4000000;
...
consensus.MAX_BLOCK_WEIGHT = 4000000;
...
consensus.MAX_BLOCK_SIGOPS = 1000000 / 50;
...
consensus.MAX_BLOCK_SIGOPS_COST = 80000;
...
consensus.VERSION_TOP_BITS = 0x20000000;
...
consensus.VERSION_TOP_MASK = 0xe0000000;
...
consensus.WITNESS_SCALE_FACTOR = 4;
...
consensus.LOCKTIME_THRESHOLD = 500000000;
...
consensus.SEQUENCE_DISABLE_FLAG = (1 << 31) >>> 0;
...
consensus.SEQUENCE_TYPE_FLAG = 1 << 22;
...
consensus.SEQUENCE_GRANULARITY = 9;
...
consensus.SEQUENCE_MASK = 0x0000ffff;
...
consensus.MAX_SCRIPT_SIZE = 10000;
...
consensus.MAX_SCRIPT_STACK = 1000;
...
consensus.MAX_MULTISIG_PUBKEYS = 20;
...
consensus.BIP16_TIME = 1333238400;
...
consensus.ZERO_HASH = Buffer.alloc(32, 0x00);
...
consensus.fromCompact = function fromCompact(compact) {
...
consensus.toCompact = function toCompact(num) {
...
consensus.verifyPOW = function verifyPOW(hash, bits) {
...
consensus.getReward = function getReward(height, interval) {
  ...
  if (halvings === 0) return consensus.BASE_REWARD;

  return consensus.HALF_REWARD >>> (halvings - 1);
};
